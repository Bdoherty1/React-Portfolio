  ...
  >
    <div className="flex flex-col justify-center h-full max-w-screen-lg p-4 mx-auto">
      ...
      <div className="flex items-center justify-center ">
        <form
          action="https://getform.io/f/pbgkeknb"
          method="POST"
        ...
        >
            ...
            <button className='flex items-center px-6 py-3 mx-auto my-8 text-white duration-300 rounded-md bg-gradient-to-b from-cyan-200 to-blue-500 hover:scale-110'>
              Submit Form</button>
          </form>
        </div>
      </div>
